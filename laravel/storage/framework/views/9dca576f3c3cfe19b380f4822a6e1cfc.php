                ...
                <div class="card card-flush">
                    ...
                    <div class="card-header mt-6">
                        ...
                        <div class="card-toolbar">
                            <!--begin::Button-->
                            <a href="<?php echo e(route('rolelist')); ?>"><input type="button" value="Danh sách sản phẩm"
                    ...
                    <div class="card-body pt-0">
                        <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                            <!--begin::Form-->
                            <form class="form" action="<?php echo e(route('insertRole')); ?>" method="post"
                                ...
                                <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_user_scroll"
                                    ...
                                    <div class="fv-row mb-7">
                                        ...
                                        <input type="text" name="role_name"
                                            ...
                                            placeholder="Tên Phân Quyền" value="<?php echo e(old('role_name')); ?>" />
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="d-flex flex-column mb-7 fv-row">
                                        ...
                                        <textarea class="form-control form-control-solid rounded-3" name="description" rows="4"><?php echo e(old('description')); ?></textarea>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Ampps\www\laravel\resources\views/admin/role/role-add.blade.php ENDPATH**/ ?>