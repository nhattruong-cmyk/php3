...
<?php $__env->startSection('titlepage', 'Danh sách phân quyền'); ?>
                ...
                <div class="card card-flush">
                    ...
                    <div class="card-header mt-6">
                        ...
                        <div class="card-toolbar">
                            <!--begin::Button-->
                            <a href="<?php echo e(route('roleaddform')); ?>"><input type="button" value="Thêm mới sản phẩm"
                    ...
                    <div class="card-body pt-0">
                            ...
                            <tbody class="fw-bold text-gray-600">
                                <?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?php echo e(route('productupdateform', $item->id)); ?>"><input
                                                    class="btn btn-warning" type="button" value="Sửa"></a>
                                            <a href="javascript:void(0);"
                                                onclick="confirmDelete(<?php echo e($item->id); ?>)"><input type="button"
                        ...
                        <nav aria-label="Page navigation example">
                            <ul class="pagination">
                                <?php echo e($roles->links('pagination::default')); ?>
    ...
    <script>
        ...
        function confirmDelete(id) {
            if (confirm("Bạn có chắc chắn muốn xóa sản phẩm này?")) {
                window.location.href = "<?php echo e(url('productdelete')); ?>/" + id;
            } else {
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Ampps\www\laravel\resources\views/admin/role/role-list.blade.php ENDPATH**/ ?>