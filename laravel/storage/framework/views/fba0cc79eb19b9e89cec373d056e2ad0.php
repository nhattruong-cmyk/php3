...
<div id="kt_header" class="header" data-kt-sticky="true" data-kt-sticky-name="header"
	...
	<div class="container-xxl d-flex align-items-center justify-content-between" id="kt_header_container">
		...
		<div class="d-flex d-lg-none align-items-center ms-n2 me-2">
			...
			<div class="btn btn-icon btn-active-icon-primary" id="kt_aside_toggle">
				...
				<span class="svg-icon svg-icon-2x">
					<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
						<path
							d="M21 7H3C2.4 7 2 6.6 2 6V4C2 3.4 2.4 3 3 3H21C21.6 3 22 3/index.php.4 22 4V6C22 6.6 21.6 7 21 7Z"
							fill="black" />
						<path opacity="0.3"
			...
			<!--begin::Logo-->
			<a href="index.php?url=home" class="d-flex align-items-center">


				<img alt="Logo" src="<?php echo e(asset('public/img/home/logo-no-background.png')); ?>" class="h-30px" />
								...
								<tbody>
										...
										<td>
											<div class="d-flex align-items-center">
												<div class="symbol symbol-45px me-5">
													<img src="<?php echo e(asset('assets/media/avatars/150-11.jpg')); ?>" alt="" />
									...
									<tr>
										...
										<td>
											<div class="d-flex align-items-center">
												<div class="symbol symbol-45px me-5">
													<img src="<?php echo e(asset('assets/media/avatars/150-3.jpg')); ?>" alt="" />
									...
									<tr>
										...
										<td>
											<div class="d-flex align-items-center">
												<div class="symbol symbol-45px me-5">
													<img src="<?php echo e(asset('assets/media/avatars/150-4.jpg')); ?>" alt="" />
									...
									<tr>
										...
										<td>
											<div class="d-flex align-items-center">
												<div class="symbol symbol-45px me-5">
													<img src="<?php echo e(asset('assets/media/avatars/150-5.jpg')); ?>" alt="" />
												</div>
												<div class="d-flex justify-content-start flex-column">
													<a href="#"
									...
									<tr>
										...
										<td>
											<div class="d-flex align-items-center">
												<div class="symbol symbol-45px me-5">
													<img src="<?php echo e(asset('assets/media/avatars/150-6.jpg')); ?>" alt="" />
												</div>
												<div class="d-flex justify-content-start flex-column">
													<a href="#"
					...
					<div class="card-body pt-5">
						...
						<div class="d-flex mb-7">
							...
							<div class="symbol symbol-60px symbol-2by3 flex-shrink-0 me-4">
								<img src="<?php echo e(asset('assets/media/stock/600x400/img-3.jpg')); ?>" class="mw-100"
						...
						<div class="d-flex mb-7">
							<!--begin::Symbol-->
							<div class="symbol symbol-60px symbol-2by3 flex-shrink-0 me-4">
								<img src="<?php echo e(asset('assets/media/stock/600x400/img-4.jpg')); ?>" class="mw-100"
						...
						<div class="d-flex mb-7">
							<!--begin::Symbol-->
							<div class="symbol symbol-60px symbol-2by3 flex-shrink-0 me-4">
								<img src="<?php echo e(asset('assets/media/stock/600x400/img-5.jpg')); ?>" class="mw-100"
									alt="" />
							</div>
							<!--end::Symbol-->
							<!--begin::Section-->
						...
						<div class="d-flex mb-7">
							<!--begin::Symbol-->
							<div class="symbol symbol-60px symbol-2by3 flex-shrink-0 me-4">
								<img src="<?php echo e(asset('assets/media/stock/600x400/img-6.jpg')); ?>" class="mw-100"
									alt="" />
							</div>
							<!--end::Symbol-->
							<!--begin::Section-->
						...
						<div class="d-flex">
							<!--begin::Symbol-->
							<div class="symbol symbol-60px symbol-2by3 flex-shrink-0 me-4">
								<img src="<?php echo e(asset('assets/media/stock/600x400/img-7.jpg')); ?>" class="mw-100"
									alt="" />
							</div>
							<!--end::Symbol-->
							<!--begin::Section-->
							<div class="d-flex align-items-center flex-wrap flex-grow-1 mt-n2 mt-lg-n1">
								<!--begin::Title-->
								<div class="d-flex flex-column flex-grow-1 my-lg-0 my-2 pe-3">
									<a href="#" class="fs-5 text-gray-800 text-hover-primary fw-bolder">Desserts
										platter</a>
				...
				<div class="card card-xxl-stretch mb-5 mb-xl-8">
					...
					<div class="card-body pt-5">
						...
						<div class="d-flex align-items-sm-center">
							...
							<div class="symbol symbol-50px me-5">
								<span class="symbol-label">
									<img src="	<?php echo e(asset('assets/media/svg/brand-logos/fox-hub.svg')); ?>"
										class="h-50 align-self-center" alt="" />
								</span>
							</div>
							<!--end::Symbol-->
				...
				<div class="card card-xl-stretch mb-xl-8">
					...
					<div class="card-body pt-2">
						...
						<div class="d-flex align-items-center mb-7">
							<!--begin::Avatar-->
							<div class="symbol symbol-50px me-5">
								<img src="	<?php echo e(asset('assets/media/avatars/150-1.jpg')); ?>" class="" alt="" />
						...
						<div class="d-flex align-items-center mb-7">
							<!--begin::Avatar-->
							<div class="symbol symbol-50px me-5">
								<img src="	<?php echo e(asset('assets/media/avatars/150-4.jpg')); ?>" class="" alt="" />
							</div>
							<!--end::Avatar-->
							<!--begin::Text-->
							<div class="flex-grow-1">
						...
						<div class="d-flex align-items-center mb-7">
							<!--begin::Avatar-->
							<div class="symbol symbol-50px me-5">
								<img src="	<?php echo e(asset('assets/media/avatars/150-12.jpg')); ?>" class="" alt="" />
							</div>
							<!--end::Avatar-->
							<!--begin::Text-->
							<div class="flex-grow-1">
						...
						<div class="d-flex align-items-center mb-7">
							<!--begin::Avatar-->
							<div class="symbol symbol-50px me-5">
								<img src="	<?php echo e(asset('assets/media/avatars/150-8.jpg')); ?>" class="" alt="" />
							</div>
							<!--end::Avatar-->
							<!--begin::Text-->
							<div class="flex-grow-1">
						...
						<div class="d-flex align-items-center">
							<!--begin::Avatar-->
							<div class="symbol symbol-50px me-5">
								<img src="<?php echo e(asset('assets/media/avatars/150-6.jpg')); ?>" class="" alt="" />
										...
										<tbody>
											...
											<tr>
												<td>
													<div class="symbol symbol-45px me-2">
														<span class="symbol-label">
															<img src="../../admin/dist/assets/media/svg/brand-logos/telegram.svg"
																class="h-50 align-self-center" alt="" />
														</span>
													</div>
												</td>
											...
											<tr>
												<td>
													<div class="symbol symbol-45px me-2">
														<span class="symbol-label">
															<img src="../../admin/dist/assets/media/svg/brand-logos/bebo.svg"
																class="h-50 align-self-center" alt="" />
														</span>
													</div>
												</td>
										...
										<tbody>
											<tr>
												<td>
													<div class="symbol symbol-45px me-2">
														<span class="symbol-label">
															<img src="../../admin/dist/assets/media/svg/brand-logos/kickstarter.svg"
																class="h-50 align-self-center" alt="" />
														</span>
													</div>
												</td>
											...
											<tr>
												<td>
													<div class="symbol symbol-45px me-2">
														<span class="symbol-label">
															<img src="../../admin/dist/assets/media/svg/brand-logos/vimeo.svg"
																class="h-50 align-self-center" alt="" />
														</span>
													</div>
												</td>
...
<?php echo $__env->make('admin.layout2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Ampps\www\thayhoLaravel\laravel\resources\views/admin/index2.blade.php ENDPATH**/ ?>