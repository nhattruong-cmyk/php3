                ...
                <div class="card card-flush">
                    ...
                    <div class="card-header mt-6">
                        ...
                        <div class="card-toolbar">
                            <!--begin::Button-->
                            <a href="<?php echo e(route('productaddform')); ?>"><input type="button" value="Thêm mới sản phẩm"
                            ...
                            <tbody class="fw-bold text-gray-600">
                                <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td><img src="<?php echo e(asset('uploaded/' . $item->img)); ?>" width="80"
                                                alt=""></td>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Ampps\www\thayhoLaravel\laravel\resources\views/admin/product/productlist.blade.php ENDPATH**/ ?>