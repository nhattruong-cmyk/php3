...
<?php $__env->startSection('titlepage', 'Cập nhật sản phẩm'); ?>
                ...
                <div class="card card-flush">
                    ...
                    <div class="card-body pt-0">
                        <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                            <!--begin::Form-->
                            <form class="form" action="<?php echo e(route('productupdate')); ?>" method="post"
                                    ...
                                    <div class="fv-row mb-7">
                                        ...
                                        <div class="image-input image-input-outline" data-kt-image-input="true"
                                            ...
                                            <div class="image-input-wrapper w-125px h-125px"
                                                style="background-image: url( <?php echo e(asset('uploaded/' . $product->img)); ?>);">
                                            </div>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="d-flex flex-column mb-7 fv-row">
                                        ...
                                        <textarea class="form-control form-control-solid rounded-3" name="description" rows="4"><?php echo e($product->description); ?></textarea>
                                        ...
                                        <select name="category_id" class="form-control form-control-solid mb-3 mb-lg-0">
                                            ...
                                            <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <?php if($item->id == $product->category_id): ?>
                                                    <option value="<?php echo e($item->id); ?>" selected><?php echo e($item->name); ?>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Ampps\www\thayhoLaravel\laravel\resources\views/admin/product/productupdateform.blade.php ENDPATH**/ ?>