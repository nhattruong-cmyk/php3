		...
		<div class="aside-footer d-flex flex-column align-items-center flex-column-auto" id="kt_aside_footer">
			...
			<div class="d-flex align-items-center mb-10" id="kt_header_user_menu_toggle">
				...
				<div class="cursor-pointer symbol symbol-40px" data-kt-menu-trigger="click" data-kt-menu-overflow="true"
					...
					<img src="../../public/img/home/logo-no-background.png" alt="image" />
				</div>
				<!--begin::Menu-->
				<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-primary fw-bold py-4 fs-6 w-275px"
					...
					<div class="menu-item px-3">
						<div class="menu-content d-flex align-items-center px-3">
							...
							<div class="symbol symbol-50px me-5">
								<img alt="Logo" src="../../public/img/home/logo-no-background.png" />
							</div>
							<!--end::Avatar-->
							<!--begin::Username-->
					...
					<!--begin::Menu item-->
					<div class="menu-item px-5">
						<a href="/index.php" class="menu-link px-5">Quay lại trang Cilent</a>
					</div>
					<!--end::Menu item-->
					<!--begin::Menu separator-->
					<div class="separator my-2"></div>
									...
									<div data-kt-menu-trigger="click" class="menu-item menu-accordion mb-1">
										...
										<div class="menu-sub menu-sub-accordion">
											<div data-kt-menu-trigger="click" class="menu-item menu-accordion mb-1">
												...
												<div class="menu-item">
													<a class="menu-link" href="index.php?url=listproducts">
														<span class="menu-bullet">
															<span class="bullet bullet-dot"></span>
														</span>
...
<!--end::Aside--><?php /**PATH D:\Ampps\www\thayhoLaravel\laravel\resources\views/admin/header2.blade.php ENDPATH**/ ?>