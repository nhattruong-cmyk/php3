...
if (!empty($_POST['add'])) {
    ...
    if (empty($category_name)) {
        ...
        $danhmuc->insert_danhmuc($category_name);

        // Cập nhật thời gian tạo mới
        date_default_timezone_set('Asia/Ho_Chi_Minh');
        $ngay_gio_hien_tai = date('Y-m-d H:i:s');
        $danhmuc->update_created_at($ngay_gio_hien_tai);
    }
}
?>
        ...
        <div class="container-xxl d-flex align-items-center justify-content-between" id="kt_header_container">
            ...
            <div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap me-lg-2 pb-2 pb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', lg: '#kt_header_container'}">
                ...
                <ul class="breadcrumb fw-bold fs-base my-1">
                    ...
                    <li class="breadcrumb-item text-dark">Thêm mới danh mục</li>
                </ul>
                <!--end::Breadcrumb-->
            </div>
            <!--end::Page title=-->
            ...
            <div class="card card-flush">
                ...
                <div class="card-header mt-6">
                   ...
                   ' . $loi . '
                    ...
                    <div class="card-toolbar">
                        <!--begin::Button-->
                        <a href="index.php?url=listcate"><input type="button" value="Danh sách danh mục" class="btn btn-light-primary">
                ...
                <div class="card-body pt-0">
                    <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                        ...
                        <form class="form" action="index.php?url=addcate" method="POST">

                            <div class="fv-row mb-7">

                                <label class="fs-6 fw-bold form-label mb-2">
                                    <span class="required">Tên danh mục</span>
                                    <i class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="popover" data-bs-trigger="hover" data-bs-html="true" data-bs-content="Danh mục chỉ có một."></i>
                                </label>

                                <input type="text" name="category_name" class="form-control form-control-solid" placeholder="Điền tên danh mục"  />
